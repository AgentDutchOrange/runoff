...
void tabulate(void)
{
    for (int i = 0; i < voter_count; i++)
    {
        // iterate over each candidate per voter
        for (int j = 0; j < candidate_count; j++)
        {
            // if particular candidate is eliminated, do not update votes. Otherwise, update.
...
bool is_tie(int min)
{
    //essentially just compare all candidate votes to the min, if they are all equal to min then tie == true, else false
    // TODO
    return false;
}
